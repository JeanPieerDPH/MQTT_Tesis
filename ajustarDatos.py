...
df = pd.read_csv('C:\\Users\\delpo\\Documents\\1_final\\Universidad\\Z_Tesis\\Topologia\\Data\\combinado_300k.csv')
...
df = df[~df['_ws.col.protocol'].isin(['0x0e00', 'BROWSER', 'MDNS', 'UDP/XML', 'ICMPv6', 'ICMP', 'IPv4', 'SSDP'])]
...
df.to_csv('C:\\Users\\delpo\\Documents\\1_final\\Universidad\\Z_Tesis\\Topologia\\Data\\dataset_final.csv', index=False)
